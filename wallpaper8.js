//this is orange cat with angry eyes
//ear
...
let white = 255
let black = 0
//let pink = color(255,192,203);//No. 56
//let green = color(173,255,0);//No. 57
//let cream = color(255,156,89);//No. 58
//let orange = color(255,88,15);//No. 59
